...
const ForgotPasswordPage: React.FC = () => {
  ...
  const handleForgotPassword = async (formData: { email: string }) => {
    try {
      ...
      setSuccessMessage('تم إرسال رمز التحقق! تفقد بريدك الإلكتروني.');
      ...
      const errorMessage = err instanceof Error ? err.message : 'فشل إرسال رمز التحقق. حاول مرة أخرى.';
    ...
    <PublicRoute redirectTo="/dashboard">
      <div className={styles.authPage}>
        ...
        <div className={styles.formCard}>
          <h2 className={styles.formTitle}>نسيت كلمة المرور</h2>
          <p className={styles.formSubtitle}>أدخل بريدك الإلكتروني أو رقم هاتفك لإرسال رمز التحقق</p>
