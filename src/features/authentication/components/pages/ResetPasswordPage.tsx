...
const ResetPasswordPage: React.FC = () => {
  ...
  const handleResetPassword = async (formData: {
    ...
    try {
      ...
      setSuccessMessage('تم تغيير كلمة المرور بنجاح! يمكنك تسجيل الدخول الآن.');
      setTimeout(() => {
        navigate('/login');
      }, 2000);
    } catch (err: unknown) {
      const errorMessage =
        err instanceof Error ? err.message : 'فشل تغيير كلمة المرور. حاول مرة أخرى.';
    ...
    <PublicRoute redirectTo="/dashboard">
      <div className={styles.authPage}>
        ...
        <div className={styles.formCard}>
          <h2 className={styles.formTitle}>تعيين كلمة مرور جديدة</h2>
          <p className={styles.formSubtitle}>أنشئ كلمة مرور جديدة لحسابك</p>
