...
import { AlertCircle, X, Loader2, Plus, Upload, Image as ImageIcon, CheckCircle2, DollarSign } from 'lucide-react';
...
export const AddUrgentCaseModal: React.FC<AddUrgentCaseModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4" dir="rtl">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-100 flex-shrink-0 bg-gradient-to-r from-red-50 to-orange-50">
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-lg bg-gradient-to-br from-[#F04930] to-[#d93d26] text-white">
              <Plus size={24} />
            </div>
            <div>
              <h2 className="text-lg font-bold text-[#101727] font-[Cairo]">
                إضافة حالة عاجلة جديدة
              </h2>
              <p className="text-xs text-[#697282] font-[Cairo] mt-1">
                أنشئ حالة عاجلة جديدة تحتاج إلى مساعدة فورية
              </p>
            </div>
          </div>
          <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  className="w-full px-4 py-3.5 rounded-xl border-2 border-gray-200 focus:outline-none focus:border-[#F04930] focus:ring-2 focus:ring-[#F04930]/20 transition-all font-[Cairo] placeholder-gray-400 bg-white hover:border-gray-300"
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#495565] font-[Cairo] flex items-center gap-2">
                  <span className="text-lg text-[#F04930]">*</span>
                  <DollarSign size={16} className="text-[#F04930]" />
                  <span>المبلغ المستهدف (جنيه)</span>
                </label>
                <div className="relative">
                  <input
                    className={`w-full pl-12 pr-4 py-3.5 rounded-xl border-2 transition-all font-[Cairo] focus:outline-none focus:ring-2 focus:ring-[#F04930]/20 hover:border-gray-300 ${
                      targetAmount <= 0 && targetAmount !== 0
                        ? 'border-red-300 focus:border-red-500'
                        : 'border-gray-200 focus:border-[#F04930]'
                    }`}
                    type="number"
                    value={targetAmount}
                    onChange={(e) => {
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  className="w-full px-4 py-3.5 rounded-xl border-2 border-gray-200 focus:outline-none focus:border-[#F04930] focus:ring-2 focus:ring-[#F04930]/20 transition-all font-[Cairo] resize-none hover:border-gray-300 bg-white"
              ...
              <div className="space-y-2">
                <label className="text-sm font-bold text-[#495565] font-[Cairo] flex items-center gap-2">
                  <ImageIcon size={16} className="text-[#F04930]" />
                  صورة الحالة العاجلة
                </label>
                <div
                  className={`relative border-2 border-dashed rounded-2xl p-3 transition-all cursor-pointer flex flex-col items-center justify-center text-center h-44 group overflow-hidden
                    ${draggingImg ? `border-[#F04930] bg-red-50` : `border-gray-300 hover:border-[#F04930] hover:bg-gray-50`}
                    ${imagePreview ? `border-solid border-[#F04930] bg-gradient-to-br from-red-50 to-white` : ``}
                  `}
                  onDragOver={(e) => {
                    e.preventDefault();
                    setDraggingImg(true);
                ...
                >
                  {imagePreview ? (
                    ...
                    <>
                      <div className="p-3 bg-gray-100 rounded-full text-gray-400 mb-2 group-hover:bg-red-100 group-hover:text-[#F04930] transition-all transform group-hover:scale-110">
                        <Upload size={24} />
                      </div>
        ...
        {/* Footer Actions */}
        <div className="p-6 border-t border-gray-100 flex items-center justify-end gap-3 flex-shrink-0 bg-gradient-to-r from-red-50/30 to-orange-50/30">
          <button
            onClick={onClose}
          ...
          <button
            ...
            className="flex items-center justify-center gap-2.5 px-8 py-2.5 rounded-xl font-bold text-white shadow-lg transition-all transform hover:scale-105 active:scale-95 font-[Cairo] disabled:opacity-50 disabled:scale-100 bg-gradient-to-r from-[#F04930] to-[#d93d26] shadow-[#F04930]/30 hover:shadow-[#F04930]/50"
          >
            {isSubmitting ? (
              <>
